...
//
// POSTHOG_API_KEY is a real, live project key — gated on cookie-consent.js
// (must be loaded first — see index.html) instead: the PostHog snippet never
// loads at all, let alone captures anything, until the visitor has explicitly
// clicked "Accept" on the cookie banner. Every window.Analytics method stays
